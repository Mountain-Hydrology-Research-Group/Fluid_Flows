...
Download the lab and data files to your computer. First you will need the lab worksheet [Mixing and Dilution Worksheet](CEE348_Spring_2022_Week9Lab.pdf)  This is will be part of Homework 8, but we want to start early.

* [Lab 7-1: Rating Curves](lab7-1.ipynb)
  * data: [Lyell_h_Q_sorted.mat](../data/Lyell_h_Q_sorted.mat)
  * image: [LyellForkTuolumnegagesite](LyellFork_Tuolumne_flowcontrol.png)
  * Note, this python workbook is optional, if you are interested in how rating curves are made.
* [Lab 7-2: Mixing and Dispersion in Rivers](lab7-2.ipynb)
