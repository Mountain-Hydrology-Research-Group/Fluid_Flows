...
We will be delineating Seattle's Cedar River Watershed as homework this week.  For homework, I would like you to use the USGS StreamStats application, but I am also providing some addition resources for other software if you are interested in checking them out. GIS is a very marketable skill, and consultants are often asked to delineate watersheds. However, the software can be tricky to get installed, so we will not have homework requiring it.  To get a good 3-D perspective of the topography, here is a useful [Youtube Geology Video](https://www.youtube.com/watch?v=DOSm-gqGEBU). 
